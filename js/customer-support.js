...
/* Original file: files/cache/assets/minified/widgets.bh_gall_widget.skins.bh_gall_tc_1.js.widget.min.js */

jQuery(function ($) {});
function doChangePageContent(target, type, next_page) {
  var _this = $(target);
  var parent_wrap = _this.closest(".bh_tab_li").length
    ? _this.closest(".bh_tab_li")
    : _this.closest(".bh_widget_wrap");
