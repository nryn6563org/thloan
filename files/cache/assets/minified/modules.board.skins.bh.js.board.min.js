...
return!1})});jQuery(function($){"use strict";$(document).ready(function(){$('.content_body').find('iframe[src*="youtube"]').wrap('<div class="bh_video_wrap"></div>')})});(function($){"use strict";$.fn.snspost=function(opts){var loc='';opts=$.extend({},{type:'twitter',event:'click',content:''},opts);opts.content=encodeURIComponent(opts.content);switch(opts.type){case 'facebook':loc='http://www.facebook.com/share.php?t='+opts.content+'&u='+encodeURIComponent(opts.url||location.href);break;case 'twitter':loc='//twitter.com/intent/tweet?text='+opts.content;break;case 'band':loc='http://www.band.us/plugin/share?body='+opts.content+'%0A'+encodeURIComponent(opts.url||location.href);break}
